import { Vector4, Vector3, Curve, Loader, LoaderUtils, FileLoader, TextureLoader, RepeatWrapping, ClampToEdgeWrapping, Texture, MeshPhongMaterial, MeshLambertMaterial, ColorManagement, Color, SRGBColorSpace, EquirectangularReflectionMapping, Matrix4, Group, Bone, PropertyBinding, Object3D, PerspectiveCamera, PointLight, MathUtils, SpotLight, DirectionalLight, SkinnedMesh, Mesh, LineBasicMaterial, Line, Skeleton, AmbientLight, BufferGeometry, Float32BufferAttribute, Uint16BufferAttribute, Matrix3, Vector2, ShapeUtils, Euler, AnimationClip, Quaternion, VectorKeyframeTrack, QuaternionKeyframeTrack, NumberKeyframeTrack } from 'three';
import { u as unzlibSync } from './fflate.module-THiBvsgv.js';
